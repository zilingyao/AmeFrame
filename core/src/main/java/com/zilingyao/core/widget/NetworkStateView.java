package com.zilingyao.core.widget;
...
import com.zilingyao.core.R;
import com.zilingyao.core.util.networkstate.UIUtils;
...
public class NetworkStateView extends LinearLayout {
    ...
    public NetworkStateView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mTextSize = typedArray.getDimensionPixelSize(R.styleable.NetworkStateView_nsvTextSize, UIUtils.dp2px(14,context));
